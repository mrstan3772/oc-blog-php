...
<head>
    ...
    <!-- Favicon icon -->
    <link rel="icon" href="/{{ attribute(config, 'get', ['assets_path']) }}/images/icons/svg/svg1.svg" type="image/x-icon">

    <!-- font css -->
    <link rel="stylesheet" href="/{{ attribute(config, 'get', ['assets_path']) }}/fonts/admin/feather.css">
    <link rel="stylesheet" href="/{{ attribute(config, 'get', ['assets_path']) }}/fonts/admin/fontawesome.css">
    <link rel="stylesheet" href="/{{ attribute(config, 'get', ['assets_path']) }}/fonts/admin/material.css">

    <!-- vendor css -->
    <link rel="stylesheet" href="/{{ attribute(config, 'get', ['assets_path']) }}/css/main.02EJNXGEKMD3NWBHKYF0TS7KJQ.min.css" id="main-style-link">
    <link rel="stylesheet" href="/{{ attribute(config, 'get', ['assets_path']) }}/css/my.min.css" id="my-style-link">
</head>
...
<body class="">
    ...
    <div class="pc-mob-header pc-header">
        <div class="pcm-logo">
            <img src="/{{ attribute(config, 'get', ['assets_path']) }}/images/admin/Logo-site-blanc-100.png" alt="" class="logo logo-lg">
        </div>
        ...
        <div class="navbar-wrapper">
            <div class="m-header">
                <a href="/admin" class="b-brand">
                    ...
                    <img src="/{{ attribute(config, 'get', ['assets_path']) }}/images/admin/Logo-site-blanc-100.png" alt="logo" class="logo logo-lg">
                    <img src="/{{ attribute(config, 'get', ['assets_path']) }}/images/admin/Logo-site-blanc-100.png" alt="logo" class="logo logo-sm">
                </a>
            </div>
        ...
        <div class="header-wrapper">
            ...
            <div class="ml-auto">
                <ul class="list-unstyled">
                    ...
                    <li class="dropdown pc-h-item">
                        <a class="pc-head-link dropdown-toggle arrow-none mr-0" data-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false">
                            <img src="/{{ attribute(config, 'get', ['assets_path']) }}/images/member/{{ user_session.memberProfilePicturePath | raw }}" alt="user-image" class="user-avtar">
                            <span>
                                <span class="user-name">{{ user_session.memberPseudonym | raw }}</span>
    ...
    <!-- Required Js -->
    <script src="/{{ attribute(config, 'get', ['assets_path']) }}/js/lib/vendor-all.min.js"></script>
    <script src="/{{ attribute(config, 'get', ['assets_path']) }}/js/plugins/bootstrap.min.js"></script>
    <script src="/{{ attribute(config, 'get', ['assets_path']) }}/js/plugins/feather.min.js"></script>
    <script src="/{{ attribute(config, 'get', ['assets_path']) }}/js/pcoded.min.js"></script>
    <!-- <script src="https://cdnjs.cloudflare.com/ajax/libs/highlight.js/9.12.0/highlight.min.js"></script> -->
    <!-- <script src="assets/js/plugins/clipboard.min.js"></script> -->
    <!-- <script src="assets/js/uikit.min.js"></script> -->

    <!-- Apex Chart -->
    <script src="/{{ attribute(config, 'get', ['assets_path']) }}/js/plugins/apexcharts.min.js"></script>

    <!-- custom-chart js -->
    <script src="/{{ attribute(config, 'get', ['assets_path']) }}/js/pages/dashboard-sale.js"></script>
</body>
