    ...
    <div class="container">
        <div class="left-section">
            <div class="inner-content">
                ...
                <p class="subheading">Il semble que la page que vous recherchiez n'est plus là.</p>
                <a class="subheading link-subheading" href="" onClick="window.history.back()">Revenir en arrière</a>
            </div>
        </div>
